...
display.getWidget("EvtTimeRaw").setPropertyValue("pv_name", "$(P)$(R)Evt"+code+"DelayRaw-SP")
display.getWidget("EvtTimeRBRaw").setPropertyValue("pv_name", "$(P)$(R)Evt"+code+"DelayRaw-RB")
