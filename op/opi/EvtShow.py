...
display.getWidget("EvtTime").setPropertyValue("pv_name", "$(P)$(R)Evt"+code+"DelayTime-SP")
display.getWidget("EvtTimeRB").setPropertyValue("pv_name", "$(P)$(R)Evt"+code+"DelayTime-RB")
display.getWidget("EvtTimeRaw").setPropertyValue("pv_name", "$(P)$(R)Evt"+code+"Delay-SP")
display.getWidget("EvtTimeRBRaw").setPropertyValue("pv_name", "$(P)$(R)Evt"+code+"Delay-RB")
