...
#dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG, num=4, desc='Diagnostic', code=0x06, time=180, mode=1, transm=0"
#dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG, num=5, desc='Septa LTB', code=0x07, time=190, mode=1, transm=0"
#dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG, num=6, desc='Egun Trigger', code=0x08, time=200, mode=1, transm=0"
#dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG, num=7, desc='Kicker LTB', code=0x09, time=210, mode=1, transm=0"

#dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG, num=8, desc='Diagnostic', code=0x0A, time=220, mode=1, transm=0"
#dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG, num=9, desc='Septa LTB', code=0x0B, time=230, mode=1, transm=0"
...
seq sncSeqRAM, "device=EVG, ev_num=4"
