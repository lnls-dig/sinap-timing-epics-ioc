...
# EVG
#dbLoadRecords("${TOP}/db/evg.db", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVG, Idx=1, ITBL_LEN=2000, PORT=EVG1, ADDR=0, TIMEOUT=2")
...
# Events
#set_pass1_restoreFile("autosave_event0_PROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVG, Idx=1, num=0")
#set_pass1_restoreFile("autosave_event1_PROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVG, Idx=1, num=1")
#set_pass1_restoreFile("autosave_event2_PROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVG, Idx=1, num=2")
#set_pass1_restoreFile("autosave_event3_PROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVG, Idx=1, num=3")
# EVR
#set_pass0_restoreFile("autosave_evr1_NOPROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=1")
#set_pass0_restoreFile("autosave_evr2_NOPROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=2")
#set_pass0_restoreFile("autosave_evr3_NOPROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=3")
#set_pass0_restoreFile("autosave_evr4_NOPROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=4")
#set_pass0_restoreFile("autosave_evr5_NOPROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=5")
#set_pass0_restoreFile("autosave_evr6_NOPROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=6")
# EVE
...
#set_pass0_restoreFile("autosave_eve4_NOPROC.sav", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVE, Idx=4")
...
# EVR
#create_monitor_set("autosave_evr1_NOPROC.req", 30, "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=1")
#create_monitor_set("autosave_evr2_NOPROC.req", 30, "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=2")
#create_monitor_set("autosave_evr3_NOPROC.req", 30, "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=3")
#create_monitor_set("autosave_evr4_NOPROC.req", 30, "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=4")
#create_monitor_set("autosave_evr5_NOPROC.req", 30, "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=5")
#create_monitor_set("autosave_evr6_NOPROC.req", 30, "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=6")
# EVE
...
#create_monitor_set("autosave_eve4_NOPROC.req", 30, "Sec=AS, Sub=Inj, Dis=TI, Dev=EVE, Idx=4")
...
#create_triggered_set("autosave_evr3_NOPROC.req", "AS-Inj:TI-EVR3:save_T", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=3")
#create_triggered_set("autosave_evr4_NOPROC.req", "AS-Inj:TI-EVR4:save_T", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=4")
#create_triggered_set("autosave_evr5_NOPROC.req", "AS-Inj:TI-EVR5:save_T", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=5")
#create_triggered_set("autosave_evr6_NOPROC.req", "AS-Inj:TI-EVR6:save_T", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVR, Idx=6")
...
#create_triggered_set("autosave_eve4_NOPROC.req", "AS-Inj:TI-EVE4:save_T", "Sec=AS, Sub=Inj, Dis=TI, Dev=EVE, Idx=4")
