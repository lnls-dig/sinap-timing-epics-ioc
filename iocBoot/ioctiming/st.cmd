...
dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG1, num=4, desc='Diagnostic', code=0x06, time=173, mode=1, transm=0"
dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG1, num=5, desc='Septa LTB', code=0x07, time=176, mode=1, transm=0"
dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG1, num=6, desc='Egun Trigger', code=0x08, time=180, mode=1, transm=0"
dbLoadRecords "${TOP}/db/Eventos.db", "device=EVG1, num=7, desc='Kicker LTB', code=0x09, time=190, mode=1, transm=0"

# Pulse Train Event
dbLoadRecords "${TOP}/db/PulseTrain.db", "device=EVG1, enable=1, code=0x0A, start_time=1408, pulse_count=1020, total_length=500000000"
...
seq sncSeqRAM, "device=EVG1, ev_num=8"
